...
#
#     title_tr = models.CharField(max_length=150,verbose_name="Ürün İsmi - TR")
...
#     content_tr = RichTextField(verbose_name="Ürün Açıklamaları - TR")
#     content_en = RichTextField(verbose_name="Ürün Açıklamaları - EN")
#     slug = models.SlugField(unique=True,editable=False,max_length=130)
#
#     image_tr = models.ImageField(verbose_name="Ürün Resmi - TR")
#     image_en = models.ImageField(blank=True,verbose_name="Ürün Resmi - EN (Zorunlu Değil)")
#
#     spec_file_tr = models.FileField(verbose_name="Teknik Özellikler Dosyası (Pdf) - TR",blank=True)
#     spec_file_en = models.FileField(verbose_name="Teknik Özellikler Dosyası (Pdf) - EN",blank=True)
#
#
#     catalog_file_tr = models.FileField(verbose_name="Ürün Kataloğu (Pdf) - TR",blank=True)
